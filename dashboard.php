...
<body class="sj-userlogin">
	...
	*************************************-->
    ...
    <span>Author</span>
							...
							<div class="sj-navigationarea">
								<strong class="sj-logo"><a href="index."><img src="images/logo.jpg" alt="company logo here"></a></strong>
						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-12">
							<div class="sj-innerbannercontent">
								...
								<ol class="sj-breadcrumb">
									<li><a href="">Home</a></li>
									<li><a href="">Submit Your Aticle</a></li>
								</ol>
							</div>
						</div>
					</div>
    ...
    <h4>Author</h4>
									...
									<div class="sj-widgetdashboard">
										<nav id="sj-dashboardnav" class="sj-dashboardnav">
											<ul>
												<li><a href="underreview.html"><i class="lnr lnr-sync"></i> <span>View Articles</span></a></li>
												<li><a href="addtemplates.html"><i class="lnr lnr-briefcase"></i> <span>Add Templates</span></a></li>
												<li><a href="aticle-list.html"><i class="lnr lnr-sync"></i> <span>Aticle List</span></a></li>
												<li><a href="generalsettings.html"><i class="lnr lnr-layers"></i> <span>General Settings</span></a></li>
												<li><a href="manageuser.html"><i class="lnr lnr-users"></i> <span>Manage Users</span></a></li>
		...
		<div class="modal-dialog" role="document">
			<div class="sj-modalcontent modal-content">
				...
				<div class="modal-body">
					<form class="sj-formtheme sj-formregister sj-formregistervtwo">
						<fieldset>
							<div class="form-group">
							...
							<div class="sj-selectgroup">
								<span class="sj-radio">
									...
									<label for="sj-qone">Admin </label>
								</span>
								<span class="sj-radio">
									<input id="sj-qtwo" type="radio" name="question" value="qtwo">
									<label for="sj-qtwo">Reviewer</label>
								</span>
							</div>
						</fieldset>
					</form>
					<form class="sj-formtheme sj-formaddproject sj-formaddprojectvtwo">
	...
	*************************************-->
	<div class="sj-modalboxarea modal fade" tabindex="-1" role="dialog" id="feedbackmodal">
		<div class="modal-dialog" role="document">
			<div class="sj-modalcontent modal-content">
				<div class="sj-popuptitle">
